...
<link rel="stylesheet" media="screen,tv" type="text/css" href="./css.php">
<link rel="stylesheet" media="print" type="text/css" href="./css.php?type=print">
...
<body>
<div id='header'>
<a href='<!--{$SiteTop}-->'><img src='<!--{$ImgURL}--><!--{#image_logo#}-->' id='logo'></a><h1><!--{$PageTitle}--></h1>
<p><!--{#hello_msg#}--></p>
</p><p class='topicpath'> <!--{$TopicPath}--> </p>
</div>
<div id='toolbar '>
<!--{foreach $ToolBarItem as $ItemKey=>$Item}-->
<a href='<!--{$Item}-->'><img src='<!--{#IMG_URL#}--><!--{$ToolBarIcon[$ItemKey]}-->' alt='<!--{$ItemKey}-->'></a>
<!--{/foreach}-->
</div>
<div id='wikibody'>
<!--{$WikiBody}-->
